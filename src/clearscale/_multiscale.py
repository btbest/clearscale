...
# pseudo-registry for grepping
_hps: TranslationShiftFunction = half_pixel_space_preservation
_ba: TranslationShiftFunction = discrete_bin_center
_fvd: TranslationShiftFunction = first_value_decimation
